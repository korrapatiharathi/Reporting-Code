...
for (i in 1:length(inputFolders)) {
  ...
  # Loop through the files to perform appropriate analysis
   for (i in 1:length(files)) {
    ...
    diskFolder <- "E:/Harathi data/HarathiWork_Automation/automation/Nodes/OUTPUTS/disk_Output/"
    ...
    # Create a new folder for outputs
    memFolder <- "E:/Harathi data/HarathiWork_Automation/automation/Nodes/OUTPUTS/Memory_Output/"
    ...
    # Check if the file type is cpu or not; if yes, calculate maximum cpu load per day
      ...
      # Create a new folder for outputs
      cpuFolder <- "E:/Harathi data/HarathiWork_Automation/automation/Nodes/OUTPUTS/Cpu_Output/"
